# Complete implementation from: https://github.com/auth0-blog/auth0-python-fastapi-sample/blob/main/application/utils.py
...
class VerifyToken:
    ...
    async def verify(self,
        ...
        try:
            ...
            raise UnauthenticatedException(detail=str(error))
